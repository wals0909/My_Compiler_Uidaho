...
%type <tree> declarationList declaration funDeclaration varDeclaration scopedALLTYPEspecificer vardeclarationList
%type <type> ALLTYPEspec
...
varDeclaration
              : ALLTYPEspec vardeclarationList SEMICOLON         { $$ = $2; setType($$, $1); }
              ;

scopedALLTYPEspecificer 
              : STATIC ALLTYPEspec vardeclarationList SEMICOLON   { $$ = $3; 
                                                                   $$->isStatic = true; 
                                                                   setType($$, $2);
                                                                  }
...
varDeclarationId     
              ...
              ;
//make sure to add ALLTYPEspecifiers for the parameters/etc!
ALLTYPEspec    : INT                                             { $$ = Integer; }
              | CHAR                                             { $$ = Char; }
              | BOOL                                             { $$ = Boolean;}
...
funDeclaration       
              : ALLTYPEspec ID OPAREN parameters 
...
parameterTypeList 
              : ALLTYPEspec parameterIdList                      { $$ = $2; setType($$, $1); }
              ;
...
localdeclaration    
              : localdeclaration scopedALLTYPEspecificer         { $$ = addSibling($1, $2); }
              | %empty                                           { $$ = NULL; }
              ;

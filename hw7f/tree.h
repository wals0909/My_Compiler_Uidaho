...
typedef struct treeNode{
    ...
    bool errWasUsed;                            // is err being used?
    bool isDeclared;                            // is variable declared.
    bool IOinit;                                // is IO Initialized
    bool errDecl;                               // is decl error being used
    bool arrayIndex;                            // is this index of array
    int mSize;                                  //memory size 
    int mOffset;                                //memory offset 
    VarKind memT;                               //var type 
    int arrLength;
    //int arrLength; change the name of this
    int emitLoc;
    int codeLine;

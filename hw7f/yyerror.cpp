...
void initErrorProcessing() {
 niceTokenNameMap["ADDASGN"] = (char *)"\"+=\"";
    ...
    niceTokenNameMap["START"] = (char *)"\"begin\"";
    ...
    niceTokenNameMap["STOP"] = (char *)"\"end\"";
    ...
    niceTokenNameMap["MULTASGN"] = (char *)"\"*=\"";
    ...
    niceTokenNameMap["LESSTHAN"] = (char *)"\'<\'";
    niceTokenNameMap["GREATERTHAN"] = (char *)"\'>\'";
...
void yyerror(const char *msg)
{
    ...
    // This threw the dumbest error msg. Needed to change "lastoken" to yytext, idk why.
    // Don't forget to Change in header as well. 
